...
-- Create assignment_helpers table (without foreign key to auth.users for sample data)
...
ON public.assignment_helpers 
FOR UPDATE 
USING ((auth.uid() = user_id AND user_id IS NOT NULL) OR (get_current_user_role() = 'admin'));
...
-- Insert sample helper data (without user_id foreign key constraint)
INSERT INTO public.assignment_helpers (name, email, contact, year, course, rating, specializations, sample_description) VALUES 
('Priya S.', 'priya@kiit.ac.in', '+91 98765 43210', '3rd Year', 'CSE', 4.9, ARRAY['Programming', 'Mathematics'], 'Beautiful cursive style with neat formatting'),
('Rahul M.', 'rahul@kiit.ac.in', '+91 87654 32109', '4th Year', 'Mechanical', 4.8, ARRAY['Technical diagrams', 'Engineering'], 'Perfect for technical drawings and calculations'),
('Sneha K.', 'sneha@kiit.ac.in', '+91 76543 21098', '2nd Year', 'MBBS', 5.0, ARRAY['Medical notes', 'Diagrams'], 'Medical precision writing with clear diagrams');