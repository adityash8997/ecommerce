-- Create orders table for food and micro-essential items
...
CREATE POLICY "Helpers can view pending orders"
ON public.orders
FOR SELECT
TO authenticated
USING (
...
CREATE POLICY "Helpers can accept orders"
ON public.orders
FOR UPDATE
TO authenticated
USING (
...
CREATE POLICY "Helpers can update their accepted orders"
ON public.orders
FOR UPDATE
TO authenticated
