...
const KiitSocieties = () => {
  ...
  const handleServiceClick = (route: string) => {
    if (route) {
      ...
      toast(
        "Coming Soon! This service is under development and will be available soon.",
        {
          icon: "👏",
        }
      );
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-2">
              ...
              <h2 className="text-3xl font-bold text-kiit-green">
                Quick Access
              </h2>
            </div>
            <p className="text-gray-600">
              Track deadlines, events, and announcements
            </p>
          </div>
              ...
              return (
                ...
                >
                  <CardHeader className="text-center pb-4">
                    <div
                      className={`p-3 rounded-2xl bg-gradient-to-r ${service.gradient} w-fit mx-auto mb-3`}
                    >
                  ...
                  <CardContent>
                    ...
                    <div className="flex items-center justify-between">
                      <span
                        className={`font-semibold px-3 py-1 rounded-full text-sm bg-gradient-to-r ${service.gradient} text-white`}
                      >
                        {service.price}
                      </span>
                      <Button
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Discover societies that match your interests and passions
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kiitSocieties.map((society, index) => {
              const upcomingEvent =
                societyEvents[society.name.toLowerCase().trim()]?.[0];
              return (
                <div
                  id={society.section}
                  key={index}
                ...
                >
                  ...
                  <div
                    className={`relative h-80 bg-gradient-to-br ${society.gradient} p-6 text-white`}
                  >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center text-2xl border border-white/30">
                        {Societies[
                          society.logoPlaceholder as keyof typeof Societies
                        ] ? (
                          <img
                            src={
                              Societies[
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-left">
                          <div className="font-semibold text-sm flex items-center gap-2">
                            ...
                            {upcomingEvent ? "Upcoming Event" : "Next Event"}
                          </div>
                        ...
                        <div className="text-right">
                          <div className="text-xs font-medium text-orange-600">
                            {upcomingEvent
                              ? moment(upcomingEvent.event_date).format(
                                  "MMM D, YYYY"
                                )
                  ...
                  <div
                    className="absolute inset-0 rounded-2xl bg-gradient-to-br opacity-0 group-hover:opacity-20 transition-opacity duration-500 pointer-events-none"
                    style={{
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-kiit-green-soft to-purple-100">
        <div className="container mx-auto text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold text-kiit-green mb-6">
              <Calendar1 className="w-4 h-4" /> Never Miss an Opportunity
            </h2>
            <p className="text-gray-600 mb-8">
              Stay updated with all society interviews, fest announcements, and
              sports events in one place.
            </p>
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Button
                className="bg-kiit-green hover:bg-kiit-green-dark text-white px-8 py-3"
                onClick={() =>
                  alert("Coming Soon! Interview tracker is under development.")
                }
              >
                Track Interviews
              </Button>
              <Button
                ...
                onClick={() => {
                  navigate("/interview-deadlines-tracker");
                }}
              >
                View All Events
              </Button>
