...
const services = [
  ...
  },
  {
    ...
    description: "Track interviews, onboarding sessions, and deadlines of all KIIT Societies, Fests, and Sports clubs.",
    price: "Free",
    gradient: "from-kiit-green to-campus-blue",
  },
  {
...
export const ServicesGrid = () => {
  ...
  const handleServiceClick = (service: typeof services[0]) => {
    const routeMap: Record<string, string> = {
      ...
      "Interview Deadlines Tracker": "/interview-deadlines-tracker",
