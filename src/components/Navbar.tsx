          ...
          <div className="hidden md:flex items-center gap-8">
            {navItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="text-foreground hover:text-kiit-green transition-colors font-medium"
              >
                {item.label}
              </a>
            ))}
          ...
          <div className="md:hidden border-t border-white/20 py-4 space-y-4">
            {navItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="block text-foreground hover:text-kiit-green transition-colors font-medium py-2"
